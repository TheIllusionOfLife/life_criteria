...
Holm-Bonferroni corrected, all $p < 0.016$), with Cohen's $d$ ranging from
0.57 to 18.1.
...
Our system is the first to achieve Level~5 on any criterion (metabolism) and
to reach $\geq$4 on five of seven criteria, with the highest total score (27)
...
Homeostasis and boundary maintenance occupy a middle tier ($\sim$59--77\%
